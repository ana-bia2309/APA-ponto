                      ...
                      <EmployeeForm
                        ...
                        onSubmit={async (data) => {
                          ...
                          const { error } = await supabase.from("employees").insert({
                            ...
                            carga_horaria_diaria_padrao: data.carga_horaria_diaria_padrao || 9,
                            carga_horaria_diaria_sexta: data.carga_horaria_diaria_sexta || 8,
                            ...(data.escala_referencia_data && { escala_referencia_data: data.escala_referencia_data }),
                            ...(data.carga_horaria_turno && { carga_horaria_turno: data.carga_horaria_turno }),
                            ...
                            <div className="space-y-3">
                              <EmployeeForm
                                ...
                                initialData={{
                                  ...
                                  carga_horaria_diaria_padrao: (emp as any).carga_horaria_diaria_padrao || 9,
                                  carga_horaria_diaria_sexta: (emp as any).carga_horaria_diaria_sexta || 8,
                                  escala_referencia_data: (emp as any).escala_referencia_data || "",
                                  carga_horaria_turno: (emp as any).carga_horaria_turno || 11,
                                  status: (emp as any).status || "ativo",
                                ...
                                onSubmit={async (data) => {
                                  const { error } = await supabase.from("employees").update({
                                    ...
                                    carga_horaria_diaria_padrao: data.carga_horaria_diaria_padrao || 9,
                                    carga_horaria_diaria_sexta: data.carga_horaria_diaria_sexta || 8,
                                    escala_referencia_data: data.escala_referencia_data || null,
                                    carga_horaria_turno: data.carga_horaria_turno || 11,
                                    ...(data.data_admissao && { data_admissao: data.data_admissao }),
                                    ...(data.data_nascimento && { data_nascimento: data.data_nascimento }),
                                    ...(data.observacoes && { observacoes: data.observacoes }),
                                    ...(data.foto_url && { foto_url: data.foto_url }),
                                    ...
                                    {(() => {
                                      ...
                                      const badges: Record<string, { emoji: string; label: string; bg: string; cor: string }> = {
                                        ...
                                        suspensao: { emoji: "🚫", label: "Suspenso", bg: "#f3f4f6", cor: "#374151" },
                                         abono_dia: { emoji: "✅", label: "Abono", bg: "#dcfce7", cor: "#166534" },
