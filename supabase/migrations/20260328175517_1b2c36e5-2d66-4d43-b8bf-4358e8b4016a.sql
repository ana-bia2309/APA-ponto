...
-- Drop the 8-parameter overload that accepts p_employee_id
DROP FUNCTION IF EXISTS public.insert_time_record_with_cpf(text, text, timestamptz, double precision, double precision, text, text, uuid);

-- Recreate the clean 7-parameter version
